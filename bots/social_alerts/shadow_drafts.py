...
CTA = "Track this alongside sleep, HRV, symptoms, and exposures in Gaia Eyes."
...
SIGNAL_SUBTITLES = {
    ...
    "cme": "Body signals look noisier today. Watch sleep, HRV trends, pain, recovery, and restless energy during this active solar window.",
}
SIGNAL_CAPTIONS = {
