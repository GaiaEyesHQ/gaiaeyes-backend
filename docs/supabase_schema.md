...
CREATE TABLE marts.daily_features (
  ...
  respiratory_rate_sleep_avg numeric,
  respiratory_rate_baseline_delta numeric,
  temperature_deviation numeric,
  temperature_deviation_baseline_delta numeric,
  temperature_source text,
  resting_hr_avg numeric,
  resting_hr_baseline_delta numeric,
  bedtime_consistency_score numeric,
  waketime_consistency_score numeric,
  sleep_debt_proxy numeric,
  sleep_vs_14d_baseline_delta numeric,
  cycle_tracking_enabled boolean NOT NULL DEFAULT false,
  cycle_phase text,
  menstrual_active boolean NOT NULL DEFAULT false,
  cycle_day integer,
  kp_max numeric,
  bz_min numeric,
  ...
  cmes_count integer,
  ulf_context_class_raw text,
  ulf_context_label text,
  ulf_confidence_score double precision,
  ulf_confidence_label text,
  ulf_regional_intensity double precision,
  ulf_regional_coherence double precision,
  ulf_regional_persistence double precision,
  ulf_quality_flags jsonb NOT NULL DEFAULT '[]'::jsonb,
  ulf_is_provisional boolean NOT NULL DEFAULT false,
  ulf_is_usable boolean NOT NULL DEFAULT false,
  ulf_is_high_confidence boolean NOT NULL DEFAULT false,
  ulf_station_count integer,
  ulf_missing_samples boolean NOT NULL DEFAULT false,
  ulf_low_history boolean NOT NULL DEFAULT false,
