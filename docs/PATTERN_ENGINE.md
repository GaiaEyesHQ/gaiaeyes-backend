...
- `marts.user_daily_outcomes`
  - Binary grouped outcomes such as `headache_day`, `migraine_day`, `pain_flare_day`, `fatigue_day`, `poor_sleep_day`, and biometric flags like `high_hr_day`, `short_sleep_day`, and `hrv_dip_day` when enough history exists.
