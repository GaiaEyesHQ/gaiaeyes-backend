...
| W17 — Android enrollment / app record — **RESOLVED availability** | Jennifer confirmed Google organization verification and Play app-record creation (portfolio D010–D011) | Do not repeat enrollment/app creation. D012 prioritizes Android quality and iOS parity; saved fields, signing, billing, upload and release acceptance remain separately unverified |
