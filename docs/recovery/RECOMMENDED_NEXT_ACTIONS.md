...
The September 17 source/disclaimer audit in [PROJECT_STATE.md](PROJECT_STATE.md#medical-framing-and-repetitive-disclaimer-review) found no broad generic Android footer pattern, but found iOS/web repetition candidates and overbroad documentation language. The next bounded copy-review pass should cover Android notification settings; iOS camera and self-reported-context notices; the iOS Patterns header fallback; and repeated web member CTAs. For each, record the actual journey, useful information, proposed consolidation and preserved measurement/consent context. The historical “clinical-feeling” reason to exclude `panic` is superseded; assess the outcome's scientific definition and product use instead. No UI or published copy was changed in this documentation pass.
...
**September 17 next-brief requirement:** carry forward the chosen increment’s user/research benefit, smallest useful scope, relevant technical or scientific acceptance, and explicit next integration step. Include how it supports acquisition, engagement, usefulness or research quality where applicable. Keep financial monitoring alongside those criteria. For disclaimer changes, verify the actual journey and retain useful measurement/consent information while consolidating general disclosure; do not add boilerplate to new symptom or medicine flows by default.
