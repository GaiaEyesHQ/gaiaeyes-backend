...
2. **Environment Configuration**
   - Add any new environment variables (e.g., `SWPC_API_EMAIL`) to `env.production`, staging, and deployment environments. Update onboarding docs so future engineers know how to configure them.
