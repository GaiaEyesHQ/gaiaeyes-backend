...
with s as (
  select
    ...
    respiratory_rate_avg, respiratory_rate_sleep_avg, respiratory_rate_baseline_delta,
    temperature_deviation, temperature_deviation_baseline_delta, temperature_source,
    resting_hr_avg, resting_hr_baseline_delta,
    bedtime_consistency_score, waketime_consistency_score,
    sleep_debt_proxy, sleep_vs_14d_baseline_delta,
    cycle_tracking_enabled, cycle_phase, menstrual_active, cycle_day
...
select
  ...
  s.respiratory_rate_avg, s.respiratory_rate_sleep_avg, s.respiratory_rate_baseline_delta,
  s.temperature_deviation, s.temperature_deviation_baseline_delta, s.temperature_source,
  s.resting_hr_avg, s.resting_hr_baseline_delta,
  s.bedtime_consistency_score, s.waketime_consistency_score,
  s.sleep_debt_proxy, s.sleep_vs_14d_baseline_delta,
  s.cycle_tracking_enabled, s.cycle_phase, s.menstrual_active, s.cycle_day,
