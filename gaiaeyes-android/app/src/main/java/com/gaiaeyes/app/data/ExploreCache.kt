...
class ExploreCache(
    ...
    override suspend fun read(accountId: String): CachedExplore? {
    ...
    override suspend fun write(accountId: String, payload: ExplorePayload, savedAtEpochMillis: Long) {
