...
class LocalWeatherPresentationTest {
    ...
    fun formatsObservationTimeInDeviceTimeZone() {
        ...
        try {
            ...
            assertEquals("Observed Aug 2, 4:35 PM · Stale", localWeatherObservedText(snapshot))
        } finally {
