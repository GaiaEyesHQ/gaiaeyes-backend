...
comment on column marts.daily_features.temperature_deviation is
  'Daily average temperature-deviation signal mirrored from gaia.daily_summary. Observational only; not diagnostic.';
